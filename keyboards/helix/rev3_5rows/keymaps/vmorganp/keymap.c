...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NAV] = LAYOUT(
    ...
    _______, _______,  _______,  _______,    KC_LEAD,  _______,    /*&&&&&&     &&&&&&*/  _______, _______,  _______, _______, _______, KC_F12,
    _______, A(KC_P9), A(KC_P1), A(KC_PDOT), A(KC_P5), A(KC_PENT), /*&&&&&&     &&&&&&*/  KC_LEFT, KC_DOWN,  KC_UP,   KC_RGHT, _______, _______,
    _______, TO(_OSX), TO(_WIN), TO(_GAME),  _______,  _______,    KC_DEL,      _______,  _______, A(KC_P2), _______, _______, _______, _______,
