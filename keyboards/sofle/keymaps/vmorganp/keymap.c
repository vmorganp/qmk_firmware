...
[_OSX] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,         KC_X,         KC_C,         KC_V,         KC_B,   _______,     KC_MPLY,      KC_N,       KC_M,         KC_COMM,      KC_DOT,       KC_SLSH,         KC_RSFT,
                          KC_LALT,      KC_LCTL,      KC_LGUI,      KC_SPC, MO(_NAV),    MO(_SYMBOLS), KC_MS_BTN1, KC_MS_BTN3,   KC_MS_BTN2,   KC_CAPS 
),
...
[_WINDOWS] = LAYOUT(
  ...
  _______, _______, _______,  _______, _______, _______, _______,   _______, _______, _______, _______, _______, _______, _______,
                    KC_LALT,  KC_LGUI, KC_LCTL, KC_SPC,  _______,   _______, _______, _______, _______, _______ 
),
...
[_GAMING] = LAYOUT(
  ...
  _______, _______, _______,  _______, _______, _______, KC_MPLY,   _______, _______, _______, _______, _______, _______, _______,
                    KC_LCTL,  KC_LCTL, KC_SPC,  KC_SPC,  _______,   _______, _______, _______, _______, _______ 
),
